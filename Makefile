...
# If you're looking to add a new target, jump to the end of the file

default: all

# The implemented primes
PRIME_LIST=p6983 p3923 p3433 p175e48c7879e3 p14ffe5311380b
# PRIME?=p175e48c7879e3
PRIME?=p3923

# To use or not to use assembly
# ASM=1  # Uncomment to activate assembly by default
...
#
## Edit here when you add new targets

# TODO: handle header deps properly
...
# Do not touch: this magically triggers implicit rules for the object files above
...
# A catchall rule for benchmarks (since they depend on all objects)
