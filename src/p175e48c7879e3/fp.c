...
const uintbig p =
  { 0x1fffffffffffffff, 0x15a6a3333b54e85a, 0x59b8124e6b240be6, 0x919b0f338d18d9ee };
// 2^256 % p
static const uintbig modp =
  { 0xe000000000000001, 0xea595cccc4ab17a5, 0xa647edb194dbf419, 0x6e64f0cc72e72611 };
...
void fp_sub3(fp *x, fp const *y, fp const *z) {
  ...
  if (borrow) {
    mpn_sub_n(x->x.c, x->x.c, modp.c, FP_LIMBS);
  }
}
