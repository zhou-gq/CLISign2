...
// const long commitment_length = 15;
...
const uintbig pow_2_65 = {0,0x2,0,0};
const uintbig pow_2_64 = {0,0x1,0,0};
const uintbig pow_2_4 = {0x10,0,0,0};
const uintbig p_minus_2_3 =          {0xd72ced4ad8f86e06,0x10408fc1d5c, 0,0};
const uintbig p_minus_2_3_cofactor = {0x7209cb5acfc9455,0x9564c892fa63d1c5, 0x33b6ac, 0};

const uintbig p_three_cofactor = {0xe41396b59f928aa, 0x2ac99125f4c7a38a, 0x676d59};
const uintbig pow_3_64 = {0x7932278c797ebd01, 0x2b56d4af8f};
